...
const Footer = () => {
  return (
    <footer className="mt-8 divide-y border-t px-4 font-normal dark:bg-gray-800 dark:text-gray-100">
      <div className="container mx-auto flex flex-col justify-between space-y-8 py-10 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <span className="self-center text-2xl font-semibold">Dripylux</span>
          </a>
        </div>
